 ...
 */
public class DectationTopologyCharlie2Resa implements Constant {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Config conf = resa.util.ConfigUtil.readConfig(new File(args[0]));
        ...
        StormSubmitter.submitTopology("ton-resa-vld-JB-cha2", resaConfig, builder.createTopology());
