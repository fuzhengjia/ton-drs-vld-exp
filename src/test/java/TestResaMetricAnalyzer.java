...
public class TestResaMetricAnalyzer {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            rt.testMakeUsingTopologyHelperForkTopology(topName, metricQueue,
                    sleepTime, maxAllowedExecutors, qos, historySize, ignoreSize);
        }catch (Exception e){
            e.printStackTrace();
        }
    }
    ...
    public void testMakeUsingTopologyHelperForkTopology(
            String topoName, String metricQueue, long sleepTime, int allewedExecutorNum,
            double qos, int historySize, int ignoreSize) throws Exception {
